...
namespace TargetClearCS
{
    public class Q4
    {
        ...
        public static void Start()
        {
            ...
            List<int> Targets = CreateTargets(MaxNumberOfTargets, MaxTarget);
            
            Console.WriteLine("Enter an number: ");
            Console.WriteLine("0. Training");
            ...
            string Choice = Console.ReadLine().ToUpper(); // Hello @AQA, ToUpper() is marginally more performant than ToLower(). Thanks!
            Console.WriteLine();
            ...
            Console.WriteLine(LargeNumberCount);
            
            NumbersAllowed = FillNumbers(NumbersAllowed, TrainingGame, MaxNumber, LargeNumberCount);
            PlayGame(Targets, NumbersAllowed, TrainingGame, MaxTarget, MaxNumber, LargeNumberCount);
            Console.ReadLine();
        }
        
        static void PlayGame(List<int> Targets, List<int> NumbersAllowed, bool TrainingGame, int MaxTarget, int MaxNumber, int LargeNumberCount)
        {
            int Score = 0;
            bool GameOver = false;
            string UserInput;
        ...
        {
            var LargeNumbers = new List<int> { 25, 50, 75, 100 };
            return LargeNumbers[RGen.Next(LargeNumbers.Count)];
        }
        ...
        static List<int> FillNumbers(List<int> NumbersAllowed, bool TrainingGame, int MaxNumber, int LargeNumberCount)
        {
            if (TrainingGame)
            {
            ...
            else
            {
                ...
                int SmallNumberCount = 5 - LargeNumberCount;
                for (int i = 0; i < SmallNumberCount; i++)
                {
                    NumbersAllowed.Add(GetNumber(MaxNumber));
                }

                for (int i = 0; i < LargeNumberCount; i++)
                {
                    NumbersAllowed.Add(GetLargeNumber());
                }
